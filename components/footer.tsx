    ...
    <footer className="relative bg-gradient-to-br from-background/60 via-background/70 to-primary/10 backdrop-blur-xl text-foreground overflow-hidden border-t border-primary/20">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-20 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 bg-primary/10 backdrop-blur-sm border border-primary/30 hover:bg-primary hover:border-primary hover:text-background rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1"
                >
          ...
          {/* Programs */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-primary">Programs</h4>
            <ul className="space-y-3">
          ...
          {/* Resources */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-primary">Resources</h4>
            <ul className="space-y-3">
