...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      {/decent-academy-v1/* Animated Background */decent-academy-v1/}
      <div className="absolute inset-0 -z-10">
        {/decent-academy-v1/* Horizontal Gradient Effect */decent-academy-v1/}
        <div className="absolute inset-0 bg-gradient-to-r from-primary/decent-academy-v1/10 via-secondary/decent-academy-v1/5 to-accent/decent-academy-v1/10" /decent-academy-v1/>
        
        {/decent-academy-v1/* Logo Background */decent-academy-v1/}
      ...
      <div className="container mx-auto px-4 lg:px-8 py-20">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/decent-academy-v1/10 rounded-full text-primary text-sm font-medium animate-scale-in border border-primary/decent-academy-v1/20 backdrop-blur-sm">
            ...
            <span>Leading Coaching Institute Since 2006</decent-academy-v1/span>
          </decent-academy-v1/div>

          {/decent-academy-v1/* Main Heading */decent-academy-v1/}
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-balance leading-tight">
            Transform Your
            <span className="block mt-2 text-primary">Academic Journey</decent-academy-v1/span>
          </decent-academy-v1/h1>

          {/decent-academy-v1/* Subheading */decent-academy-v1/}
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Excellence in education for 5th to 12th grade students. Expert faculty, proven methodologies, and a
            commitment to your success.
          </decent-academy-v1/p>

          {/decent-academy-v1/* CTA Buttons */decent-academy-v1/}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/contact">Book Free Demo</decent-academy-v1/Link>
            </decent-academy-v1/Button>
          </decent-academy-v1/div>

          {/decent-academy-v1/* Trust Indicators */decent-academy-v1/}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12 max-w-4xl mx-auto">
            {[
              ...
              >
                ...
                <div className="text-sm text-muted-foreground font-medium">{stat.label}</decent-academy-v1/div>
              </decent-academy-v1/div>
            ))}
          </decent-academy-v1/div>
        </decent-academy-v1/div>
      ...
      {/decent-academy-v1/* Scroll Indicator */decent-academy-v1/}
      <div className="absolute bottom-8 left-1/decent-academy-v1/2 -translate-x-1/decent-academy-v1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-primary rounded-full flex items-start justify-center p-2">
          <div className="w-1.5 h-3 bg-primary rounded-full animate-pulse" /decent-academy-v1/>
        </decent-academy-v1/div>
      </decent-academy-v1/div>
