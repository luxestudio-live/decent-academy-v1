...
export default function AboutPage() {
  return (
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4 lg:px-8 py-12">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/decent-academy-v1/10 rounded-full text-primary text-sm font-medium border border-primary/decent-academy-v1/20">
              ...
              <span>20 Years of Educational Excellence</decent-academy-v1/span>
            </decent-academy-v1/div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-balance leading-tight">
              About
              <span className="block mt-2 text-primary">Decent Academy</decent-academy-v1/span>
      ...
      {/decent-academy-v1/* Mission & Vision */decent-academy-v1/}
      <section className="py-16 lg:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/decent-academy-v1/* Mission */decent-academy-v1/}
            <div className="group relative bg-card rounded-3xl border border-border/decent-academy-v1/50 hover:border-primary/decent-academy-v1/50 p-12 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0 bg-gradient-to-br from-primary to-accent opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-500" /decent-academy-v1/>
              <div className="relative z-10">
                <div className="w-20 h-20 bg-gradient-to-br from-primary to-accent rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                  <Target className="w-10 h-10 text-white" /decent-academy-v1/>
                </decent-academy-v1/div>
            ...
            {/decent-academy-v1/* Vision */decent-academy-v1/}
            <div className="group relative bg-card rounded-3xl border border-border/decent-academy-v1/50 hover:border-primary/decent-academy-v1/50 p-12 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
              <div className="absolute inset-0 bg-gradient-to-br from-accent/decent-academy-v1/10 to-secondary/decent-academy-v1/10 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-500" /decent-academy-v1/>
              <div className="relative z-10">
                <div className="w-20 h-20 bg-gradient-to-br from-accent to-secondary rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                  <Eye className="w-10 h-10 text-white" /decent-academy-v1/>
                </decent-academy-v1/div>
      ...
      {/decent-academy-v1/* Core Values */decent-academy-v1/}
            ...
            {values.map((value, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    <value.icon className="w-8 h-8 text-white" /decent-academy-v1/>
                  </decent-academy-v1/div>
                  <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors duration-300">
                    {value.title}
                  </decent-academy-v1/h3>
                  <p className="text-muted-foreground leading-relaxed">{value.description}</decent-academy-v1/p>
                </decent-academy-v1/div>
              </decent-academy-v1/div>
            ))}
          </decent-academy-v1/div>
      ...
      {/decent-academy-v1/* Our Journey Timeline */decent-academy-v1/}
      <section className="py-16 lg:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-balance">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative">
              {/decent-academy-v1/* Timeline Line */decent-academy-v1/}
              <div className="absolute left-1/decent-academy-v1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-accent to-secondary hidden lg:block" /decent-academy-v1/>

              {/decent-academy-v1/* Timeline Items */decent-academy-v1/}
                ...
                {milestones.map((milestone, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      >
                        <div className="text-4xl font-bold text-primary mb-3">{milestone.year}</decent-academy-v1/div>
                        <h3 className="text-2xl font-bold mb-2 group-hover:text-primary transition-colors duration-300">
                          {milestone.event}
                        </decent-academy-v1/h3>
                        <p className="text-muted-foreground leading-relaxed">{milestone.description}</decent-academy-v1/p>
                      </decent-academy-v1/div>
                    </decent-academy-v1/div>

                    {/decent-academy-v1/* Center Dot */decent-academy-v1/}
                    <div className="hidden lg:block absolute left-1/decent-academy-v1/2 -translate-x-1/decent-academy-v1/2">
                      <div className="w-6 h-6 bg-gradient-to-br from-primary to-accent rounded-full border-4 border-background shadow-lg" /decent-academy-v1/>
                    </decent-academy-v1/div>

                    {/decent-academy-v1/* Spacer */decent-academy-v1/}
                    <div className="flex-1 hidden lg:block" /decent-academy-v1/>
                  </decent-academy-v1/div>
                ))}
              </decent-academy-v1/div>
            </decent-academy-v1/div>
      ...
      {/decent-academy-v1/* CTA Section */decent-academy-v1/}
      <section className="py-16 lg:py-20 bg-muted/decent-academy-v1/30">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-primary via-accent to-secondary rounded-3xl p-12 lg:p-16 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-balance">Ready to Begin Your Journey?</decent-academy-v1/h2>
              ...
              <Button size="lg" className="bg-white text-primary hover:bg-white/decent-academy-v1/90 text-lg px-8 py-6 group" asChild>
                <Link href="/contact">
                  <span className="flex items-center gap-2">
                    Contact Us Today
                    <BookOpen className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" /decent-academy-v1/>
                  </decent-academy-v1/span>
