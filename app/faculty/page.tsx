...
const facultyList: FacultyMember[] = [
	{
		...
		specialization: "",
		achievements: [],
		image: "/public/ramkrishna-badgujar.jpg",
	...
	},
	{
		...
		specialization: "",
		achievements: [],
		image: "/public/pratik-sawant.jpg",
		color: "from-accent to-secondary",
	},
	{
		...
		achievements: [],
		image: "/public/pravin-thorat.jpg",
	...
	},
	{
		...
		specialization: "",
		achievements: [],
		image: "/public/santosh-sawant.jpg",
		color: "from-secondary to-primary",
	},
	{
		...
		specialization: "",
		achievements: [],
		image: "/public/arun-gauda.jpg",
		color: "from-primary to-accent",
	},
	// Add all new faculty here
	{
		name: "Ramkrishna Badgujar",
		subject: "English",
		qualification: "MA B.Ed - English",
		...
		specialization: "",
		achievements: [],
		image: "/decent-academy-v1/ramkrishna-badgujar.jpg",
		color: "from-secondary to-primary",
	},
	{
		name: "Sujeet Patil",
